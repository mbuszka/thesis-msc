...
I also derive a procedure for computing control-flow analysis of programs in \IDL{} using abstracting abstract machines methodology.

The thesis is accompanied by an implementation of the algorithm in the form of a command-line tool.
It allows for transformation of an interpreter embedded in a \textit{Racket} source file and gives fine-grained control over the resulting machine.
